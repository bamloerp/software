...
-- CreateEnum
CREATE TYPE "public"."ProjectStatus" AS ENUM ('PLANNED', 'PREPARING', 'READY', 'ONGOING', 'ON_HOLD', 'COMPLETED', 'CLOSED', 'DEPOSIT_PENDING', 'SCHEDULING_PENDING', 'CREATED');
...
CREATE TABLE "public"."Quote" (
    ...
    "discountPolicy" TEXT,
    "metaJson" TEXT,
    "pgRate" DOUBLE PRECISION NOT NULL DEFAULT 2.0,
    "contingencyRate" DOUBLE PRECISION NOT NULL DEFAULT 10.0,
    "assumptions" TEXT,
    "exclusions" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "public"."Project" (
    ...
    "createdById" TEXT,
    "office" TEXT,
    "status" "public"."ProjectStatus" NOT NULL DEFAULT 'CREATED',
...
CREATE TABLE "public"."ProcurementRequisitionItem" (
    ...
    "stagedUnitPriceMinor" BIGINT DEFAULT 0,
...
CREATE TABLE "public"."ProjectProductivitySetting" (
    ...
    "tilerBuilder" DOUBLE PRECISION NOT NULL DEFAULT 20,
    "tilerAssistant" DOUBLE PRECISION NOT NULL DEFAULT 20,
...
-- CreateTable
CREATE TABLE "public"."RateOverride" (
    "id" TEXT NOT NULL,
    "code" TEXT NOT NULL,
...
CREATE TABLE "public"."_ScheduleItemAssignees" (
    ...
    CONSTRAINT "_ScheduleItemAssignees_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "Project_projectNumber_idx" ON "public"."Project"("projectNumber");
...
-- CreateIndex
CREATE INDEX "ScheduleItem_plannedStart_idx" ON "public"."ScheduleItem"("plannedStart");

-- CreateIndex
CREATE INDEX "ScheduleItem_plannedEnd_idx" ON "public"."ScheduleItem"("plannedEnd");
...
-- CreateIndex
CREATE UNIQUE INDEX "RateOverride_code_key" ON "public"."RateOverride"("code");
...
-- AddForeignKey
ALTER TABLE "public"."ProjectTask" ADD CONSTRAINT "ProjectTask_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "public"."Project"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Purchase" ADD CONSTRAINT "Purchase_purchaseOrderId_fkey" FOREIGN KEY ("purchaseOrderId") REFERENCES "public"."PurchaseOrder"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Dispatch" ADD CONSTRAINT "Dispatch_assignedToDriverId_fkey" FOREIGN KEY ("assignedToDriverId") REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."ProjectProductivitySetting" ADD CONSTRAINT "ProjectProductivitySetting_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "public"."Project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."ScheduleTaskReport" ADD CONSTRAINT "ScheduleTaskReport_reporterId_fkey" FOREIGN KEY ("reporterId") REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."ScheduleTaskReport" ADD CONSTRAINT "ScheduleTaskReport_scheduleItemId_fkey" FOREIGN KEY ("scheduleItemId") REFERENCES "public"."ScheduleItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."RateOverride" ADD CONSTRAINT "RateOverride_updatedById_fkey" FOREIGN KEY ("updatedById") REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_ScheduleItemAssignees" ADD CONSTRAINT "_ScheduleItemAssignees_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Employee"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_ScheduleItemAssignees" ADD CONSTRAINT "_ScheduleItemAssignees_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."ScheduleItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
