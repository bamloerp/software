...
export const QUOTE_LINE_MAP: QuoteLineSource[] = [
  ...
  { code: 'Z1', description: 'Pit sand', unit: 'm3', rate: 20, section: 'SUPERSTRUCTURE BRICKWORK' },
  { code: 'D22', description: 'Cement PC 15 (50kg bags)', unit: 'bags', rate: 12.5, section: 'SUPERSTRUCTURE BRICKWORK' },
  { code: 'A25', description: 'Common bricks', unit: 'no', rate: 0.16, section: 'SUPERSTRUCTURE BRICKWORK' },
  ...
  { code: 'Z4', description: 'Brickforce for one brick wall (20 metre rolls)  (230mm)', unit: 'rolls', rate: 2.50, section: 'SUPERSTRUCTURE BRICKWORK' },
  { code: 'Z5', description: 'Brickforce for half  brick wall (20 metre rolls)(115mm)', unit: 'rolls', rate: 2.50, section: 'SUPERSTRUCTURE BRICKWORK' },
  { code: 'C29', description: 'Transport', unit: 'Km', rate: 0.65, section: 'SUPERSTRUCTURE BRICKWORK' },


  { code: 'Z3', description: 'Pit sand', unit: 'm3', rate: 20, section: 'ABOVE RING BEAM' },
  { code: 'A45+1', description: 'River Sand', unit: 'm3', rate: 20, section: 'ABOVE RING BEAM' },
  { code: 'Z2', description: 'Cement PC 15 (50kg bags)', unit: 'bags', rate: 12.5, section: 'ABOVE RING BEAM' },
   {code: 'C45', description: '19mm Grenite Quarry Stone aggrecates', unit: 'm3', rate: 38, section: 'ABOVE RING BEAM' },
  { code: 'A36', description: 'Common bricks', unit: 'no', rate: 0.16, section: 'ABOVE RING BEAM' },
  { code: 'Z6', description: 'Brickforce for one brick wall (20 metre rolls)  (230mm)', unit: 'rolls', rate: 2.50, section: 'ABOVE RING BEAM' },
  { code: 'Z7', description: 'Brickforce for half  brick wall (20 metre rolls)(115mm)', unit: 'rolls', rate: 2.50, section: 'ABOVE RING BEAM' },
  { code: 'D48', description: 'Y16 reinforcemet steel', unit: 'Length', rate: 8.80, section: 'ABOVE RING BEAM' },
  { code: 'F54+D45', description: 'Y12 reinforcemet steel', unit: 'Length', rate: 5.20, section: 'ABOVE RING BEAM' },
  { code: 'E45', description: 'Y10 reinforcement steel', unit: 'Length', rate: 3.90, section: 'ABOVE RING BEAM' },
  { code: 'E54', description: 'Bailing wire', unit: 'kgs', rate: 3.0, section: 'ABOVE RING BEAM' },
  { code: 'C29', description: 'Transport', unit: 'Km', rate: 0.65, section: 'ABOVE RING BEAM' },
  { code: 'C4', description: '228mm Timber for Ring Beam Shuttering', unit: 'm', rate: 1.50, section: 'ABOVE RING BEAM' },
  ...
  { code: 'D52', description: 'Pit sand external', unit: 'cm3', rate: 20, section: 'EXTERNAL PLASTERING' },
  { code: 'G51', description: 'Internal Airvents', unit: 'no', rate: 5.0, section: 'EXTERNAL PLASTERING' },
  { code: 'H51', description: 'External Airvents', unit: 'no', rate: 5.0, section: 'EXTERNAL PLASTERING' },
  ...
  { code: 'H12', description: 'Brickwork', unit: 'm2', rate: 4.50, section: 'SUPERSTRUCTURE TO RING BEAM', itemType: 'LABOUR', labourNote: 'Brickwork in superstructure laid in stretcher bond, 1:4 cement mortar mix and reinforced with brickforce every third corse up to the ring beam level.' },
  ...
  // ABOVE RING BEAM
  { code: 'I12-50', description: 'Brickwork', unit: 'm2', rate: 4.50, section: 'ABOVE RING BEAM', itemType: 'LABOUR', labourNote: 'Brickwork in superstructure laid in stretcher bond PC cement, laid in 1:4 cement mortar reinforced with brickforce every third corse up to the ring beam level.' },
